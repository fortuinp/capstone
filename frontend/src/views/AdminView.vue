          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input v-model="payload.amount" type="text" placeholder="amount" class="form-control">
                <h5 class="text-start mt-2">Category: </h5>
                <input v-model="payload.prodCategory" type="text" placeholder="category" class="form-control">
              ...
              <div class="modal-footer">
                ...
                <button @click="addProduct()" type="button" class="btn btn-dark">Add product</button>
              </div>
            </div>
          </div>
        </div>
