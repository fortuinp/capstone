        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input v-model="payload.quantity" type="number" placeholder="Quantity" class="form-control"
                required>
              ...
              <input v-model="payload.amount" type="number" placeholder="Amount" class="form-control" required>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <h5 class="text-start mt-2">Product Quantity: </h5>
              <input v-model="payload.quantity" type="text mt-2" :placeholder="product.prodQuantity"
                class="form-control">
              <h5 class="text-start mt-2">Product URL: </h5>
              <input v-model="payload.prodUrl" type="text mt-2" :placeholder="product.prodUrl" class="form-control">
              <h5 class="text-start mt-2">Product Amount: </h5>
              <input v-model="payload.amount" type="text" :placeholder="product.prodAmount" class="form-control">
              <h5 class="text-start mt-2">Product Description: </h5>
